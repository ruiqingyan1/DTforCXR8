...
def main():
    ...
    TEACHER_CKPT_PATH = '../2-OFA-595/model2.pth'
    ...
    teacher_model = darmo.create_model("ofa595_1k", num_classes=1000, pretrained=True)
    ...
    torch.save(student_model.state_dict(), 'modeld2.pth')
