...
def main():
    ...
    TEACHER_CKPT_PATH = '../1-EEEA-Net-C2/model1.pth'
    ...
    teacher_model = darmo.create_model("eeea_c2", num_classes=1000, pretrained=True)
    teacher_model.reset_classifier(num_classes=N_CLASSES, dropout=0.2)
    ...
    torch.save(student_model.state_dict(), 'modeld1.pth')
